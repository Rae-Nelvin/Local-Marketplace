<x-app-layout>
    <div class="my-8 ml-8 mr-4 flex static">
        <!-- Start of Cart Content -->
        <div class="w-2/3 min-w-[340px] mx-2 my-3 static">
            ...
            <div class="bg-white shadow-md rounded-lg p-2 border-2 my-3">
                ...
                <div class="mt-6 mb-2 flex justify-between mx-4">
        ...
        <div>
            ...
            <div class="w-80 my-3 mx-2 bg-white shadow-md rounded-lg p-2 border-2 fixed">
    ...
    <div class="my-8 ml-8 mr-4 flex">
        <div class="w-2/3 bg-white mx-2 p-2">
            <h1 class="font-bold text-xl">Rekomendasi untukmu</h1>
